  ...
  <body class="dark muda" id="contBg">
    ...
    ?>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="box-left muda bg-img imgc-size" style="background-image: url(img/cont/JM_5.png);width:100%;height:100%;"></div></div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-12 col-md-4" ><div class="box-right muda bg-img imgc-size" style="background-image: url(img/cont/JM_2.jpg);width:100%;height:100%;"></div></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="box-left muda bg-img imgc-size" style="background-image: url(img/cont/JM_4.png);width:100%;height:100%;background-position: center 70%;"></div></div>
            <div class="col-12 col-md-8 text-justify font-s-11"> 
		...
		<div class="row mb-4">
          ...
          <div class="col-12 col-md-4" ><div class="box-right muda bg-img imgc-size" style="background-image: url(img/cont/JM_3.jpg);width:100%;height:100%;"></div></div>
		...
		<p class="text-justify mb-4 font-s-11 recuo"> Jannuccio, que durante todo esse tempo passara uma vida triste e desconsolada, acreditando que seus filhos haviam sido devorados por lobos, apressou-se agora com a maior alegria em procurar o príncipe e lhe disse que havia perdido os filhos. E quando ele contou a história, como ele foi compelido a levá-los para a floresta, o príncipe deu-lhe uma boa repreensão, chamando-o de estúpido por permitir que uma mulher colocasse o calcanhar em seu pescoço até que ele fosse levado para mandar embora duas joias como seus filhos. Mas depois de ter quebrado a cabeça de Jannuccio com essas palavras, aplicou nela o emplastro da consolação, mostrando-lhe os filhos, que o pai abraçou e beijou por meia hora sem se dar por satisfeito. </p>
		 ...
		 <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="box-left muda bg-img imgc-size" style="background-image: url(img/cont/JM_6.png);width:100%;height:100%;background-position: center 70%;"></div></div>
            <div class="col-12 col-md-8 text-justify font-s-11"> 
        ...
        echo '</div>';
          ...
          echo '<a href="gerar_cert.php?post=7" target="_blank"><button type="button" id="env" class="btn btn-color-blue-3 mt-0 mb-1 border border-color-blue-1 px-5 py-2">Gerar certificado</button></a></center>';
        }
