...
<html lang="pt-br">
  ...
  <body class="dark muda" id="contBg">
    ...
    <img src="<?php echo $conto.'img96.png' ?>" class="" style="width:100%;height:430px;object-fit: cover;object-position: center 25%;"> 
    ...
    ?>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="box-left muda bg-img imgc-size" style="background-image: url(img/cont/img91.jpg);width:100%;height:100%;"></div></div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-12 col-md-4" ><div class="box-right muda bg-img imgc-size" style="background-image: url(img/cont/img95.gif);width:100%;height:100%;"></div></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="box-left muda bg-img imgc-size" style="background-image: url(img/cont/img90.jpg);width:100%;height:100%;background-position: center 70%;"></div></div>
            <div class="col-12 col-md-8 text-justify font-s-11"> 
		...
		<div class="row mb-4">
          ...
          <div class="col-12 col-md-4" ><div class="box-right muda bg-img imgc-size" style="background-image: url(img/cont/img89.jpg);width:100%;height:100%;"></div></div>
