  ...
  <body class="dark muda" id="contBg">
    ...
    <div class="container-fluid mt-4  wt-geral  position-relative" style="min-height:81vh;">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="bg-img imgc-size" style="background-image: url(img/cont/salsa.jpeg);width:100%;height:100%;background-position: center 40%;"></div></div>
            <div class="col-12 col-md-8 text-justify font-s-12"> 
		   ...
		   <div class="row mb-4">
			...
			<div class="col-12 col-md-4" ><div class="bg-img imgc-size" style="background-image: url(img/cont/escada.png);width:100%;height:100%;background-position: center 10%;"></div></div>
        </div>
