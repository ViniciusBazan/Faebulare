...
<html lang="pt-br">
  ...
  <body class="dark muda" id="contBg">
    ...
    <img src="<?php echo $conto.'img32.jpg' ?>" class="" style="width:100%;height:480px;object-fit: cover;object-position: center 20%;"> 
    ...
    <div class="container-fluid mt-4  wt-geral  position-relative" style="min-height:81vh;">
        ...
        <center><h3 class="font-antic mt-3 mb-5"> Giambattista Basile </h3></center>
        ...
        <div class="row mb-4">
          ...
          <div class="col-12 col-md-4" ><div class="bg-img imgc-size" style="background-image: url(img/cont/menina.jpg);width:100%;height:100%;"></div></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-4" ><div class="bg-img imgc-size" style="background-image: url(img/cont/salsa.jpeg);width:100%;height:100%;background-position: center 70%;"></div></div>
            <div class="col-12 col-md-8 text-justify font-s-12"> 
