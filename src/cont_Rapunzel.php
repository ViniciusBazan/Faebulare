  ...
  <body class="dark muda" id="contBg">
    ...
    ?>
        ...
        <p class="recuo text-justify mb-4 font-s-12"><span class="font-london font-s-30 mr-2 px-3 border switch-cap text-white muda" style="line-height: 1;">E</span>ra uma vez uma mulher chamada Pascadozzia. Estando um dia diante de uma janela que dava para o jardim de uma ogra, viu um lindo canteiro de salsa, pela qual sentiu tanta saudade que quase desmaiou; e sendo incapaz de resistir ao seu desejo, ela observou até que a ogra saiu, e então arrancou um punhado dela.</p>
              ...
              <p class="recuo mb-4 text-justify font-s-12">Mas quando a ogra voltou para casa e ia cozinhar seu guisado, ela descobriu que alguém tinha estado na salsa e disse: </p> 
              <p class="recuo mb-4 text-justify font-s-12">A pobre mulher desceu repetidas vezes ao jardim, até que uma manhã a ogra a encontrou e, furiosa, exclamou: </p>
			  <p class="recuo mb-4 text-justify font-s-12">- Afinal, eu te peguei, seu ladrão, seu malandro? Prithee, você paga o aluguel do jardim, que você vem desta maneira atrevida e rouba minhas plantas? Pela minha fé, mas eu vou fazer você fazer penitência! </p>
        ...
        <div class="row mb-4">
          ...
          <div class="col-12 col-md-8 text-justify font-s-12"> 
		              <p class="recuo mb-4 text-justify">-  Que azar para mim, mas vou pegar esse patife de dedo comprido e fazê-lo se arrepender, e ensiná-lo à sua custa que cada um deve comer do seu próprio prato, e não se meter com as xícaras dos outros. </p>
			  
		  <p class="recuo mb-4">- As palavras são apenas vento, respondeu a ogra; </p> 
		   <p class="recuo mb-4">- Não vou ser pego com essa tagarelice; você fechou o balanço da vida, a menos que prometa me dar o filho que você tiver, menina ou menino, seja ele qual for.</p>
            <p class="recuo mb-4">A pobre Pascadozzia, para escapar do perigo em que se encontrava, jurou com as mãos cumprir a promessa. Portanto, a ogra a soltou. Mas quando chegou a sua hora, Pascadozzia deu à luz uma menina, tão bonita que era uma alegria olhar, que, por ter um belo ramo de salsa no seio, se chamava Salsa.</p> 
			<p class="recuo mb-4">E a garotinha crescia dia após dia, até que ela tinha sete anos de idade sua mãe a mandou para a escola; e toda vez que ela ia pela rua e encontrava a ogra, a velha lhe dizia: </p>  </div>
        ...
        <p class="recuo text-justify mb-4 font-s-12">- Diga a sua mãe para se lembrar da promessa.</p>
        <p class="recuo text-justify mb-4 font-s-12">E ela repetia esta mensagem tantas vezes, que a pobre mãe, não tendo mais paciência para ouvir a mesma história, disse um dia a Salsa: </p>
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md-8 text-justify font-s-12"> 
              <p class="recuo mb-4">-Se você encontrar a velha como sempre, e ela te lembrar da promessa odiosa , responda a ela, 'Pegue!' </p>
			  ...
			  <p class="recuo mb-4">- Puxa!</p>
              <p class="recuo mb-4"> E quando ele foi puxado, ele rastejou pela pequena janela para a câmara.</p>
			</div>	
        </div>
        ...
        <p class="recuo text-justify mb-4 font-s-12">A história de Zeza foi ouvida com tanto prazer até o fim que, se tivesse continuado por mais uma hora, o tempo teria aparecido apenas um momento.</p>
